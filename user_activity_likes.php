		...
		<div class="container" id="user_profile_container" style="">
			...
			<div class="row">
				<div class="col-md-4" style="">
					...
					<div class="row" id="profile_detail_row" style="background-color: #4caf50; color: white;" onclick="location.href='user_activity_likes.php'">
						<div class="col-sm-12" id="profile_details">
					...
					<form>
						<div class="row" style="margin-bottom: 3rem;">
							...
							<?php
								...
								$select_user_total_jobs = "SELECT * FROM liked WHERE arbeitnehmer_email='".$arbeitnehmer_email."' ORDER BY liked_id DESC";
							...
							?>
											<div class="col-sm-6 col-md-4">
												<div class="jobbox" id="<?php echo($row['job_post_id']); ?>">
													<img src="Job_Post_img/<?php echo($row2['job_post_image']); ?>" alt="job_img" class="job_img">
												</div>
											</div>
							<?php
										}
