		...
		<div class="container" id="user_profile_container" style="">
			...
			<div class="row">
				<div class="col-md-4" style="">
					...
					<div class="row" id="profile_detail_row" style="background-color: #4caf50; color: white;" onclick="location.href='user_activity_applications.php'">
					...
					<div class="row" id="profile_detail_row" onclick="location.href='user_activity_saves.php'">
						<div class="col-sm-12" id="profile_details">
				...
				<div class="col-md-8" style="background-color: ; padding: 40px;">
							...
							<table class="table table-hover">
								<thead id="thead">
									<tr>
										...
										<th scope="col" style="position: sticky; top: 0; background-color: #c8e6c9;">Antragsdatum</th>
									</tr>
								</thead>
								<tbody id="tbody">
									<?php
										...
										$select_user_total_jobs = "SELECT * FROM job_application WHERE arbeitnehmer_email='".$arbeitnehmer_email."' ORDER BY job_application_id DESC";
										...
										$temp_application_id=mysqli_num_rows($selected_user_total_jobs);
											...
											while($row=mysqli_fetch_assoc($selected_user_total_jobs))
											{
												...
												{
									?>
													<tr class="each_application" id="<?php echo($row['job_post_id']); ?>" style="cursor: pointer;">
					...
					<script type="text/javascript">
						...
						$(".each_application").click(function(){
